...
export const ExpiredTrialPricingModal: React.FC<ExpiredTrialPricingModalProps> = ({
  ...
  const currentPriceText = 
    selectedPlan === '1YEAR' ? '200.000đ' : 
    selectedPlan === '2YEAR' ? '250.000đ' : '500.000đ';
  ...
  const zaloLink = `https://zalo.me/${BRAND.zalo}?text=Thay%20Thanh%20oi,%20toi%20muon%20kich%20hoat%20${encodeURIComponent(currentPlanName)}.%20Ma%20may:%20${encodeURIComponent(hardwareCode)}`;
      ...
      >
        ...
        <div className="text-center space-y-2.5 max-w-2xl mx-auto pt-1">
          ...
          <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
            Thầy/Cô vừa hoàn thành <strong>5 lượt tạo sản phẩm thực tế</strong> và tiết kiệm được hơn 10 giờ làm việc căng thẳng! 
            Để tiếp tục đồng hành cùng Thầy/Cô trong suốt các kỳ thi và năm học 2026 – 2027, tác giả <strong>Thầy giáo Đinh Văn Thành</strong> gửi tặng chương trình trợ giá đặc biệt:
          </p>
        </div>

        {/* 3 THẺ BẢNG GIÁ LÔI CUỐN */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 pt-2">
          
          {/* THẺ 1: GÓI 1 NĂM (200K) */}
          <div
          ...
          >
            <div className="space-y-2.5">
              ...
              <p className="text-[11px] text-blue-300/90 font-medium">Chỉ ~16.000đ/tháng (chưa bằng 1 ly cà phê)</p>
          ...
          {/* THẺ 2: GÓI 2 NĂM VIP (250K) - KHUYẾN MẠI ĐẾN HẾT THÁNG 11/2026 */}
          <div
          ...
          >
            ...
            <div className="space-y-2.5 pt-1">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] text-slate-400 line-through">Gốc: 300.000đ</span>
              </div>
              ...
              <p className="text-[11px] text-emerald-400 font-bold">Chỉ 125.000đ/năm (Rẻ nhất cho Thầy/Cô)</p>
              <ul className="text-xs text-slate-300 space-y-1.5 pt-1 border-t border-slate-800">
                ...
                <li className="flex items-center gap-1.5 text-amber-300 font-semibold">
                  ⚠️ Sau 30/11/2026 trở về giá 300k/2 năm
                </li>
              </ul>
            </div>
          ...
          {/* THẺ 3: GÓI FULL WEB (500K) - TẤT CẢ PHẦN MỀM */}
          <div
          ...
          >
            ...
            <div className="space-y-2.5">
              ...
              <div className="text-2xl font-black text-emerald-400">
                500.000đ <span className="text-xs text-slate-400 font-normal">/trọn gói</span>
              </div>
            ...
            <button className={`w-full mt-4 py-2 rounded-xl text-xs font-bold transition ${
              ...
              {selectedPlan === 'FULL_WEB' ? '✓ ĐANG CHỌN FULL WEB' : 'Chọn Gói Full Web 500k'}
            </button>
          </div>
        </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Đang chọn: <strong className="text-white">{currentPlanName}</strong> — Số tiền: <strong className="text-amber-400 text-sm">{currentPriceText}</strong>
                </p>
              </div>
            </div>
