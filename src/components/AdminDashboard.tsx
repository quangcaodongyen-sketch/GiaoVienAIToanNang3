...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ isOpen, onClose }) => {
  ...
  // Tab chuyển đổi giữa TTS, NLS-AI và Tạo Đề Tiếng Anh (CV 7991)
  const [adminTab, setAdminTab] = useState<'tts' | 'nls' | 'taode'>('tts');
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
      <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-6xl w-full p-4 sm:p-6 text-white shadow-2xl my-auto max-h-[95vh] flex flex-col">
        ...
        {/* TAB CHUYỂN ĐỔI: 1. SMART LISTENING PRO | 2. TÍCH HỢP NLS-AI V2 | 3. TẠO ĐỀ TIẾNG ANH CV 7991 */}
        <div className="flex gap-2 my-3 border-b border-slate-800 pb-2 text-xs font-bold shrink-0 overflow-x-auto">
          ...
          >
            ...
            2. Tool Tạo Key Ed25519 - NLS-AI V2
          </button>
          <button
          ...
          >
            ...
            3. Tool Tạo Key Bản Quyền - Đề Tiếng Anh THCS (CV 7991)
          </button>
        </div>
