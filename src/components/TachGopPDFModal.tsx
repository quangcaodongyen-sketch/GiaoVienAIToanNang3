              ...
              <div className="p-5 rounded-2xl bg-gradient-to-r from-blue-950/60 via-slate-900 to-indigo-950/60 border-2 border-cyan-500/50 shadow-xl space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-slate-300">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-start gap-2">
                      <span className="text-emerald-400 font-bold">✓</span>
                      <span><strong>Bộ công cụ PDF toàn năng:</strong> Tách trang, gộp file, nén PDF giảm dung lượng, xoay trang, xóa trang rác không giới hạn.</span>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                    ...
                    <div className="flex items-start gap-2">
                      <span className="text-emerald-400 font-bold">✓</span>
                      <span><strong>Cập nhật dài lâu:</strong> Miễn phí cập nhật các thuật toán xử lý tài liệu mới nhất.</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-2 flex flex-col sm:flex-row items-center gap-3">
                  <a
                    href={`https://zalo.me/${BRAND.phone.replace(/[^0-9]/g, '')}?text=${encodeURIComponent(
                      `Chào Thầy Thành, tôi muốn nhận tư vấn và báo giá chi tiết phần mềm PDF Suite Pro. Mã máy của tôi: ${hwid}.`
                    )}`}
                    target="_blank"
